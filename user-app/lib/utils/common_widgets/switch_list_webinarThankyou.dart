...
@RoutePage()
class SwitchListWebinar extends StatelessWidget {
  const SwitchListWebinar({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => UserProfileCubit(UserProfileRepository()),
      child: const MySwitchListWebinarThankyouView(),
    );
  }
}

class MySwitchListWebinarThankyouView extends StatefulWidget {
  const MySwitchListWebinarThankyouView({super.key});

  @override
  State<MySwitchListWebinarThankyouView> createState() =>
      _MySwitchListWebinarThankyouViewState();
}

class _MySwitchListWebinarThankyouViewState
    extends State<MySwitchListWebinarThankyouView> {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            getIt<AppRouter>().push(const WebinarThankyou());
          },
        ),
                              ...
                              leading: Container(
                                ...
                                child: const Padding(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    backgroundImage: NetworkImage(
                                      '',
                                      // getUpdatedUserData[index].patientDetails![index].profilePicture!,
                                    ),
                                  ),
                                ),
                              ),
                                              ...
                                              onPressed: () {
                                                final userData = UserData(
                                                  ...
                                                  phone: getUpdatedUserData[0]
                                                      .phone,
                                                  isParent: false,
                                                  //  profilePicture:getUpdatedUserData[0].patientDetails?[index]
                                                );
