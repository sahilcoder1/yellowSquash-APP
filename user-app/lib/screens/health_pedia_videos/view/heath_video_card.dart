...
class HealthVideoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isFavorite =
        favoritesProvider.favoriteHealthPediaVideo.contains(healthData);
    return Padding(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (isFavorite) {
                                    favoritesProvider
                                        .removeFromHealthPediaVideoDataFavorites(
                                      healthData,
                                    );
                                  } else {
                                    favoritesProvider
                                        .addToHealthPediaVideoDataFavorites(
                                      healthData,
                                    );
                                  }
                                },
